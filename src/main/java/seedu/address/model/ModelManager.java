...
public class ModelManager implements Model {
    ...
    public void sortFilteredPersonListByAge() {
        sortedPersons.setComparator(Comparator.comparingInt(person -> Integer.parseInt(person.getAge().toString())));
    }

    @Override
    public void sortFilteredPersonListByParentName() {
        sortedPersons.setComparator(
                Comparator.comparing(person -> person.getParentName().toString(), String.CASE_INSENSITIVE_ORDER));
    }
    ...
    public void sortFilteredPersonListByParentEmail() {
        sortedPersons.setComparator(
                Comparator.comparing(person -> person.getParentEmail().toString(), String.CASE_INSENSITIVE_ORDER));
    }
