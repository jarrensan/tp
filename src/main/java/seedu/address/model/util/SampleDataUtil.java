    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Name("Alex Yeoh"), new Age("11"),
                    ...
                    new Phone("98765432"), new Email("andreyeoh@gmail.com"), EMPTY_REMARK,
                    new DietaryRemark("Allergic to seafood"), new ClassRemark("5A"), EMPTY_BEHAVIORREMARK),
            new Person(new Name("Bernice Yu"), new Age("10"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                    getTagSet("colleagues", "friends"), new Name("Jacob Yu"),
                    new Phone("98765432"), new Email("jacobyu@gmail.com"), new Remark("Hobby is playing Roblox"),
                    EMPTY_DIETARYREMARK, new ClassRemark("4C"), new BehaviorRemark("Very quiet")),
