...
public class SampleDataUtil {
    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Name("Alex Yeoh"), new Age("11"), new Phone("87438807"),
            ...
            new Person(new Name("Bernice Yu"), new Age("10"), new Phone("99272758"),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Age("7"), new Phone("93210283"),
            ...
            new Person(new Name("David Li"), new Age("11"), new Phone("91031282"),
            ...
            new Person(new Name("Irfan Ibrahim"), new Age("8"), new Phone("92492021"),
            ...
            new Person(new Name("Roy Balakrishnan"), new Age("7"), new Phone("92624417"),
